...
class FollowersFragment : Fragment() {
    ...
    private val followersViewModel by viewModels<FollowFragmentViewModel>()
    ...
    private fun setViewModel(){
        with(followersViewModel) {
            ...
            isCalled.observe(viewLifecycleOwner) { called ->
                if (!called) getUserFollowers(username.toString())
            }
    ...
    private fun setFollowersList(list: ArrayList<UserItem>) {
